...
__global__ void kernUpdateVelNeighborSearchScattered(
    ...
    int i = particleArrayIndices[sIdx];                 // original boid index
    glm::vec3 p = pos[i];
    ...
    const int r = 1; // check +/- 1 cell in each axis (27 cells)
